A Note on baseurl
You currently have baseurl: "/music".

Important: Whenever you link to images in your Markdown or studio.html include, ensure you use the relative_url filter.

The Test: In your sample Moog post, I suggested img: /img/portfolio/cabin.png. Because of your baseurl, Jekyll will correctly point this to /music/img/portfolio/cabin.png.
